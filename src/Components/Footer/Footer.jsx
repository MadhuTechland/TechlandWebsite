	...
	const socialLinks = [
		{
			...
			svg: <svg class="socialSvg linkdinSvg" viewBox="0 0 448 512">
				<path
		...
		},
		{
			...
			svg: <svg class="socialSvg whatsappSvg" viewBox="0 0 16 16">
				<path
		...
		},
		{
			...
			svg: <svg class="socialSvg phoneSvg" width="32" viewBox="0 0 32 32" height="32" fill="none" >
...

		{
			...
			svg: <svg class="socialSvg twitterSvg" viewBox="0 0 16 16" fill="currentColor" height="16" width="16" xmlns="http://www.w3.org/2000/svg"	>
				<path
		...
		},
		{
			...
			svg: <svg class="socialSvg instagramSvg" viewBox="0 0 16 16">
				<path
							...
							<div className="col-xl-3 col-md-6">
								<div className="footer-widget">
									...
									<ul className="links">
										...
										<li><a href="mailto:helldesigner@gmail.com">helldesigner@gmail.com</a></li>
